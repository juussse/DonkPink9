...
function drawImage(context, image, x, y, angle, nWidth, nHeight) {
    const width = nWidth===undefined?image.width:nWidth;
    const height = nHeight===undefined?image.height:nHeight;
